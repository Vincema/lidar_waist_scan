...
def find_optimal_smooth_factor():
    ...
    print("Optimized smooth factor values = " , smoothFactor[0] , " and " , smoothFactor[1])


def loess_algorithm():
    global distancePoints global loessPointsIter1 loessPointsIter1 = []
    global loessPointsIter2 loessPointsIter2 = [] global
    loessResultXY loessResultXY = []
...
def loess_regression(datas,smoothFact,useYi,useRobust):
    ...
    # Make nSub odd if even and =1 if ==0
    if nSub == 0:
    nSub = 1
    nSub = nSub - (1 - nSub%2)
